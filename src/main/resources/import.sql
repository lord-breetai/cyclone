...
insert into country(countryid, name, createdate, version) values (3, 'Japon1', CURRENT_TIMESTAMP, 1);
insert into country(countryid, name, createdate, version) values (4, 'Japon2', CURRENT_TIMESTAMP, 1);
insert into country(countryid, name, createdate, version) values (5, 'Japon3', CURRENT_TIMESTAMP, 1);
insert into country(countryid, name, createdate, version) values (6, 'Japon3a', CURRENT_TIMESTAMP, 1);
insert into country(countryid, name, createdate, version) values (7, 'Japon3s', CURRENT_TIMESTAMP, 1);
insert into country(countryid, name, createdate, version) values (8, 'Japon3b', CURRENT_TIMESTAMP, 1);
insert into country(countryid, name, createdate, version) values (9, 'Japon3d', CURRENT_TIMESTAMP, 1);
insert into country(countryid, name, createdate, version) values (10, 'Japon3e', CURRENT_TIMESTAMP, 1);
insert into country(countryid, name, createdate, version) values (11, 'Japon3r', CURRENT_TIMESTAMP, 1);
insert into country(countryid, name, createdate, version) values (12, 'Japon3g', CURRENT_TIMESTAMP, 1);
insert into country(countryid, name, createdate, version) values (13, 'Japon3h', CURRENT_TIMESTAMP, 1);
